...
#_______________________________________________ Assignment 3 ____________________________________________________________________ 
...
# Bonus Question : 
# -----Apply a Category-Wide Discount ----
@app.put("/products/discount")
def apply_discount(
    category : str = Query(...),
    discount_percent : int = Query(...,gt=1,le=100)
):
    update_products = []
    ...
    return {
        ...
        "updated_count" : len(update_products),
...
#---- Complete Lifecycle -------- CRUD ( POST GET PUT DELETE )
